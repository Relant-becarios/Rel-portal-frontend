...
// REGLA: Si el vehículo está en MANTENIMIENTO, solo OWNER puede editarlo.
...
// 🚫 ACCIÓN PARA CANCELAR RESERVA POR ID
...
// 🚫 CANCELAR RESERVA DIRECTAMENTE DESDE LA TARJETA DEL AUTO EN_USO
const cancelarReservaPorVehiculo = async (vehiculoId: string) => {
  ...
  if (prestamoActivo) {
    ...
    alert('No se encontró un registro activo de préstamo en curso para este vehículo.')
  }
}
          ...
          <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              ...
              <div class="flex justify-between items-start">
                ...
                <!-- 🔽 SELECTOR DE ESTADO: SOLO OWNER SI ESTÁ EN MANTENIMIENTO -->
                <select 
              ...
              <!-- 🚫 CANCELACIÓN DIRECTA SI ESTÁ EN_USO -->
          ...
          <div class="space-y-3">
            <div v-for="p in prestamos" :key="p.id" :class="esModoOscuro ? 'bg-zinc-900 border-zinc-800' : 'bg-white border-slate-200 shadow-sm'" class="rounded-2xl border p-5 flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div v-if="p.estado === 'EN_CURSO'" class="shrink-0 flex flex-col sm:flex-row gap-2">
                ...
                <button 
                  v-if="p.solicitanteId === result?.me?.id || esOwner" 
